    ...
    <div class="character-detail-info">
        ...
        <div class="info-table">
            <table>
                ...
                <tr>
                    <th>危险等级</th>
                    <td><span class="danger-level high">★★★★☆</span></td>
                </tr>
            </table>
        </div>
    ...
    <section class="detail-section">
        ...
        <div class="section-content">
            ...
            <ul>
                ...
                <li><strong>常饮饮品：</strong>果汁类饮料</li>
            ...
            <div class="relationship-grid">
                <a href="../tomori_penguin" class="relationship-card">
                    <div class="rel-avatar">
                        <img src="https://cdn.jsdelivr.net/gh/Shuixin-xdu/Shuixin-xdu.github.io@main/docs/contents/pictorial_guide/tomori_penguin.png" alt="Tomori企鹅">
                    </div>
                    <div class="rel-info">
                        <h4>Tomori企鹅</h4>
                        <p class="rel-type">乐队伙伴 / 重要朋友</p>
                ...
                <a href="../soyo_fox" class="relationship-card">
                    <div class="rel-avatar">
                        <img src="https://cdn.jsdelivr.net/gh/Shuixin-xdu/Shuixin-xdu.github.io@main/docs/contents/pictorial_guide/soyo_fox.png" alt="Soyo狸">
                    </div>
                    <div class="rel-info">
                        <h4>Soyo狸</h4>
                        <p class="rel-type">乐队伙伴 / 情感依赖</p>
                ...
                <a href="../角色名.md" class="relationship-card">
                    <div class="rel-avatar">
                        <img src="https://cdn.jsdelivr.net/gh/Shuixin-xdu/Shuixin-xdu.github.io@main/docs/contents/pictorial_guide/角色名.png" alt="角色名">
                    </div>
                    <div class="rel-info">
                        <h4>角色名</h4>
