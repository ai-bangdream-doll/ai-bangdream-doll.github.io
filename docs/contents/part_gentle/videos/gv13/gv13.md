---
title: 'soyorin和小天素罗亲密互动'
description: 'soyorin和小天素罗亲密互动'
layout: video
hide:
  - navigation  
  - toc
...
<div class="video-detail">
    ...
    <div class="video-container aspect-16-9" id="videoContainer">
        <!-- 使用外部视频播放器 -->
        <iframe 
            src="//player.bilibili.com/player.html?isOutside=true&aid=115763394381220&bvid=BV1roB4BkEf8&cid=34910635719&p=1" 
            frameborder="0" 
