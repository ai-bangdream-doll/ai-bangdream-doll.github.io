---
title: 'soyo教你如何饲养anon犬（附妙妙工具使用方法）'
description: 'soyo教你如何饲养anon犬（附妙妙工具使用方法）'
layout: video
hide:
  - navigation  
  - toc
...
<div class="video-detail">
    ...
    <div class="video-container aspect-16-9" id="videoContainer">
        <!-- 使用外部视频播放器 -->
        <iframe 
            src="//player.bilibili.com/player.html?isOutside=true&aid=115655265289432&bvid=BV1oa2xBJEVV&cid=34475608536&p=1" 
            frameborder="0" 
