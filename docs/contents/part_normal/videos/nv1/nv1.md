...
<div class="video-detail">
    ...
    <div id="videoContainer" class="video-container aspect-16-9">
        <video controls>
            <source src="https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/videos/nv/nv1.mp4" type="video/mp4">
            您的浏览器不支持视频播放。
        </video>
    </div>
    ...
    <div class="video-info">
        <h2 class="video-title">[My狗1]一次买狗的经历</h2>
