...
<div class="video-detail">
    ...
    <div id="videoContainer" class="video-container aspect-16-9">
        <video controls>
            <source src="https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/videos/nv/nv3.mp4" type="video/mp4">
            您的浏览器不支持视频播放。
        </video>
    </div>
    ...
    <div class="video-info">
        <h2 class="video-title">[My狗3]阿侬的故事</h2>
