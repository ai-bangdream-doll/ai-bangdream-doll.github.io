---
title: '[测试]小anon们一只犬在外一定要小心'
description: '[测试]小anon们一只犬在外一定要小心'
layout: video
hide:
  - navigation  
  - toc
...
<div class="video-detail">
    ...
    <div id="videoContainer" class="video-container aspect-16-9">
        <video controls>
            <source src="https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/videos/nv/nv0.mp4" type="video/mp4">
            您的浏览器不支持视频播放。
        </video>
    </div>
    ...
    <div class="video-info">
        <h2 class="video-title">[测试]小anon们一只犬在外一定要小心</h2>
