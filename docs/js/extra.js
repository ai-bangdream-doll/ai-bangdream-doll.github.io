document.addEventListener('DOMContentLoaded', function() {
    ...
    // ==================== GIF图片URL ====================
    const imageUrls = {
        initial: 'https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/decoration/2025-12-25-1.webp',
        close: 'https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/decoration/2025-12-25-2.webp',
        received: 'https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/decoration/2025-12-25-3.webp'
    };
        ...
        <div id="festivalPopup">
            ...
            <div class="popup-content">
                ...
                <div class="popup-image-container">
                    <img id="popupImage" src="${imageUrls.initial}" alt="节日礼物" 
    ...
    function setupPopupInteraction(container, popup) {
        ...
        closeBtn.addEventListener('click', function() {
            if (!received) {
                // 未接收状态：更换文字、图片，并使用4秒淡出
                popupText.textContent = '把这盒东西扔出去！';
                popupImage.src = imageUrls.close;
        ...
        receiveBtn.addEventListener('click', function() {
            received = true;
            popupImage.src = imageUrls.received;
